...
request(url, function(err, resp, body) {
    ...
    var twittertextgrey = "In the last 24 hours, sewage *may* have flowed into the city's rivers for " + greyTimeHours + greyTimeMinutes + ". " + exclaim + " " + poopEmoji;
    var twittertextblack = "In the last 24 hours, sewage *probably* flowed into the city's rivers for " + blackTimeHours + blackTimeMinutes + ". " + exclaim + " " + poopEmoji;
